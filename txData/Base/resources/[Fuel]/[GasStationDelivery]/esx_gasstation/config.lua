...
Config.webhook ="https://discord.com/api/webhooks/1146815277347131474/wtNP5ZAz4vhcabicL2Jo0gSHqZxPH00FGYBkK5Btb7dLeRaD2Xozy2cgapsDzLxNzC2q"                  -- Webhook to send logs to discord
...
Config.format = {
	...
	['location'] = 'pt-PT'						-- This is the location of your country, to format the decimal places according to your standard [Examples: pt-BR, en-US]
}
...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		['buy_price'] = 1,									-- Price to buy this gas station
		['sell_price'] = 1,								-- Price to sell this gas station
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		['stock_capacity'] = 5000,				-- Maximum stock capacity
		['min_gas_price'] = 20,					-- Minimum price that the owner can apply
		['max_gas_price'] = 50,					-- Maximum price that the owner can apply
		...
		['ressuply_deliveryman'] = {					-- Driver contracts
			...
			['price_per_liter'] = 40					-- Standard price per contract liter
		},
		['ressuply'] = {								-- Definition of contracts for the owner
			[1] = {
				['name'] = 'Small cargo',				-- Name in contract
				['price_per_liter_to_import'] = 30,		-- Price per liter to import
			...
			[3] = {
				['name'] = 'Large cargo',
				['price_per_liter_to_import'] = 10,
				['price_per_liter_to_export'] = 50,
				['liters'] = 200,
				['max_distance'] = 99,
				['truck_level'] = 5,
				['img'] = 'caminhao.png'
		...
		['blips'] = {							-- Create the blips on the map
			...
			['name'] = "Posto Combustivel",			-- Blip Name
			['color'] = 41,						-- Blip Color
...
Config.clear_gas_stations = {
	...
	['cooldown'] = 192				-- Time (in hours) that the store needs to be below the minimum amount of stock to be removed
}
...
Config.delivery_locations = {
	...
	{-3155.8750,1143.7355,21.0793,146.0461},
