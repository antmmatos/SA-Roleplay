function InsertSQL()
    if Config.AutoInsertSQL then
        ...
        if Config.Framework == 'esx' then
            DatabaseQuery('CREATE TABLE IF NOT EXISTS owned_vehicles (owner VARCHAR(50) NULL DEFAULT NULL, plate VARCHAR(8) NOT NULL, vehicle LONGTEXT NULL DEFAULT NULL, in_garage TINYINT(1) NULL DEFAULT 0, garage_id VARCHAR(50) NULL DEFAULT \'A\', garage_type VARCHAR(50) NULL DEFAULT \'car\', job_personalowned VARCHAR(50) NULL DEFAULT \'\', property INT(10) NOT NULL DEFAULT 0, impound INT(10) NOT NULL DEFAULT 0, impound_data VARCHAR(255) NULL DEFAULT \'\', adv_stats VARCHAR(255) NULL DEFAULT \'{"plate":"nil","mileage":0.0,"maxhealth":1000.0}\', PRIMARY KEY (plate) USING BTREE, INDEX vehsowned (owner) USING BTREE) COLLATE=\'utf8mb4_bin\' ENGINE=InnoDB;')
