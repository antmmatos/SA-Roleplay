...
Config.Strings = {
	...
	JerryCanEmpty = "O Jerrycan está vazio",
	FullTank = "O tanque está cheio",
	PurchaseJerryCan = "Compras-te o Jerrycan por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pressiona ~g~E ~w~para parares de abastecer",
	CancelFuelingJerryCan = "Pressiona ~g~E ~w~para parares de abastecer",
	NotEnoughCash = "~r~Não tens dinheiro suficiente",
	RefillJerryCan = "Reabasteceu o jerrycan por ",
	NotEnoughCashJerryCan = "~r~Não tens dinheiro suficiente para reabastecer o jerrycan",
	JerryCanFull = "~g~Jerrycan está cheio",
	TotalCost = "Custo",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Compraste um jerrycan"
	Config.Strings.RefillJerryCan = "Você reabasteceu o jerrycan"
end
